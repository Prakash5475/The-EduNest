 ...
 *   post:
 *     summary: Email the school its invoice PDF (requires the PDF already generated + SMTP configured)
 *     tags: [Admin Invoices]
 */
router.post('/:id/send', validate(invoiceIdParamSchema), adminInvoiceController.send);
