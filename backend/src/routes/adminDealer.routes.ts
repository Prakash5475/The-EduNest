...
import { createDealerSchema, listDealersSchema, dealerIdParamSchema, updateDealerStatusSchema, updateDealerSchema } from '@/validators/adminDealer.validators';
 ...
 * /admin/dealers:
 *   post:
 *     summary: Create a new dealer account
 *     tags: [Admin Dealers]
 */
router.post('/', validate(createDealerSchema), adminDealerController.create);
...
router.patch('/:id', validate(updateDealerSchema), adminDealerController.update);
