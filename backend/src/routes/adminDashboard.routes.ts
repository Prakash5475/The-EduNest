...
/**
 * @openapi
 * /admin/dashboard/top-schools:
 *   get:
 *     summary: Top schools by real paid revenue
 *     tags: [Admin Dashboard]
 */
router.get('/top-schools', adminDashboardController.topSchools);

/**
 * @openapi
 * /admin/dashboard/payment-methods:
 *   get:
 *     summary: Real payment collections grouped by method
 *     tags: [Admin Dashboard]
 */
router.get('/payment-methods', adminDashboardController.paymentMethods);
