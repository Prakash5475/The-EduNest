...
import { createSchoolSchema, listSchoolsSchema, schoolIdParamSchema, updateSchoolStatusSchema } from '@/validators/adminSchool.validators';
 ...
 * /admin/schools:
 *   post:
 *     summary: Create a new school account
 *     tags: [Admin Schools]
 */
router.post('/', validate(createSchoolSchema), adminSchoolController.create);
