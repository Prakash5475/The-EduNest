  ...
  const submitMutation = useMutation({
    mutationFn: (values: QuotationForm) =>
      createQuotationRequest({
        ...
        items: [
          {
            // Backend requires a productId, a kitId, or a customItemName — a bare
            // description alone fails validation with "Each item needs a product, a
            // kit, or a custom item name" (400). This is a genuine bulk/custom request,
            // so it always takes the custom-item path.
            customItemName: values.category,
            customItemDescription: values.requirements,
