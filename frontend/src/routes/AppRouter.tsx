...
const InventoryOps = lazy(() => import("@/pages/admin/InventoryOps"));
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "delivery-partners", element: withSuspense(DeliveryPartners) },
      { path: "inventory-ops", element: withSuspense(InventoryOps) },
